var actorChars = {
  //actually an object? actor is anything that moves
  '@': Player, // constructor = what the type of thing is. relationship between symbol and type
  'o': Coin,
  'm': Meow
};
function Level(plan) {
  ...
  this.grid = [];
  this.actors = [];
  //grid and actors, now populate them
...
//
      var Actor = actorChars[ch]; // why it's an obj, not tradtional array
      //using simply type of obj to something something
      if (Actor)
      this.actors.push(new Actor (new Vector(x,y), ch));
      // every actor corresp to this func to every actor vector ch something
//
      // if (ch==='@')
...
// HOVER LOGIC for coins or whatever
//if wanted for something like a projectile need slightly diff, a thing for speed, trajectory, etc
function Coin (pos) {
...
//whenever yr writing a constructor for an actor make sure you give it a type
